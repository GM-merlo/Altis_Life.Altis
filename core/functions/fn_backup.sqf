...
_backupmsg setMarkerTextLocal format ["%1 ha richiesto aiuto qua!", _player getVariable["realname",name _player]];

[1,format["%1 ha bisogno di aiuto!",name _player]] remoteExecCall ["life_fnc_broadcast",west];
uiSleep _deleteTime;
