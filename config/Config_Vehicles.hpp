    ...
    */
    ...
    class civ_air {
        ...
        vehicles[] = {
			...
			{ "I_Heli_Transport_02_F", "call life_donorlevel >= 1" },
			{ "B_T_VTOL_01_infantry_F", "call life_donorlevel >= 3" }, //Apex DLC
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "C_SUV_01_F", "" },
			{ "C_Hatchback_01_F", "call life_coplevel >= 1" },
...
class LifeCfgVehicles {
    ...
    */
    ...
    class B_Heli_Transport_01_F {
        ...
        textures[] = {
			{ "Polizia", "cop", {
                "textures\ghost_carab.jpg",
				"textures\ghost_carab1.jpg"
            }, "" },
			{ "GIS", "cop", {
                "textures\black_gis1.jpg",
				"textures\black_gis2.jpg"
            }, "" }
		};
    };
    ...
    class B_G_Offroad_01_armed_F {
        vItemSpace = 65;
        conditions = "license_civ_rebel || license_civ_bandito || {!(playerSide isEqualTo civilian)}";
        price = 750000;
        textures[] = { };
    };
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
            ...
            { "Polizia", "cop", {
                "textures\off_pol.jpg"
            }, "" },
			{ "EMS", "med", {
                "textures\off_ems.jpg"
            }, "" }
        };
    };
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
			...
			{ "Medici", "med", {
                "textures\hatchback_med.jpg"
            }, "" },
            { "Polizia", "cop", {
                "textures\hatch_pol.jpg"
            }, "" }
        };
    };
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
			...
			{ "Ferrari", "civ", {
                "textures\suv_ferrari.jpg"
            }, "" },
			{ "BMW", "civ", {
                "textures\suv_bmw.jpg"
            }, "" },
			{ "Monster", "civ", {
                "textures\suv_monster.jpg"
            }, "" },
            { "Polizia", "cop", {
                "textures\suv_pol.jpg"
            }, "" },
			{ "EMS", "med", {
                "textures\suv_ems.jpg"
            }, "" }
        };
    };
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            { "Polizia", "cop", {
                "textures\humm_pol.jpg"
            }, "" },
			{ "Monster", "civ", {
                "textures\eli_monster.jpg"
            }, "" },
            { "Sheriff", "civ", {
