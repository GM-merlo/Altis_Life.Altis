...
/* System Settings */
    ...
    fuel_cost = 160; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    /* Vehicle Sell Prices */
    vehicle_sell_multiplier_CIVILIAN = 1; //Civilian Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
