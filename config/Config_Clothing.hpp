...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            ...
            { "U_O_OfficerUniform_ocamo", "", 350, "call life_coplevel >= 2" },
			{ "U_C_WorkerCoveralls", "", 350, "license_cop_gis" },
			{ "U_B_CombatUniform_mcam_vest", "", 350, "call life_coplevel >= 7 && license_cop_gis" }
        };
        headgear[] = {
            { "NONE", $STR_C_Remove_headgear, 0, "" },
            { "H_Cap_police", "", 25, "" },
        ...
        backpacks[] = {
            ...
            { "B_Kitbag_cbr", "", 800, "license_cop_gis" },
            { "B_Bergen_sgg", "", 2500, "" },
            { "B_Carryall_cbr", "", 3500, "" },
			{ "B_Parachute" , "", 1000, "" }
        };
    ...
    class med_clothing {
        ...
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_Kitbag_cbr", $STR_C_EMS_backpacks, 3000, "" }
        };
    };
