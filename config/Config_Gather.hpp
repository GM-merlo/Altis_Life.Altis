...
*/
    ...
    class Minerals {
		...
		class garbage_zone {
			amount = 2;
			zones[] = { "garbage_1", "garbage_2" };
			item = "";
			mined[] = { {"garbage_bag",0,90},{"electronic_parts",90,94},{"cpu_processor",94,95},{"pezze_ar_culo",95,96},{"plastic_piece",96,97},{"petardo_nesploso",97,100} };
			zoneSize = 30;
		};
    };
};