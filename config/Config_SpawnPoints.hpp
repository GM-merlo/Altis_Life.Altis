    ...
    class Altis {
        class Civilian {
            class Kavala {
                ...
                conditions = "!license_civ_rebel || !license_civ_mafia";
            };
        ...
        class Cop {
            ...
            class Air {
                displayName = Aeroporto di Athira;
        ...
        class Medic {
            class Kavala {
                displayName = Ospedale di Kavala;
            ...
            class Athira {
                displayName = Ospedale Aeroporto;
